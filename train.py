...
def main() -> None:
    ...
    srnet = get_model("srnet", pretrained=config.pretrained)  # [generator, discriminator]
    ...
    for epoch in range(begin_epoch, config.max_epoch):
        # training
        start = time.time()
        img_train_out_path = os.path.join(result_path, f"6_9/train/{epoch}.jpg")
        img_val_out_path = os.path.join(result_path, f"6_9/val/{epoch}.jpg")
